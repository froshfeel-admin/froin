...
contract FROINToken {
    string public constant _myTokeName = 'froin';
    string public constant _mySymbol = 'FRO';
    uint public constant _myinitialSupply = 250000000;
...
contract MyAdvancedToken is owned, FROINToken {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) FROINToken(initialSupply, tokenName, tokenSymbol) public {}
